...
const Task = ({ taskObj, onComplete }) => {
  ...
  return (
    <div className="p-6 bg-[#fff] rounded-[5px] leading-6 mt-4 shadow-[0_4px_5px_0_rgba(0,0,0,0.1)] ">
      ...
      <div className="text-sm pt-1">son teslim: <span className={isDeadlineClose? "bg-[#ffd9d4] p-1" : "bg-[none] p-1" } >{distance}</span></div>
      <p className="text-sm pt-2 pb-2 text-[#444]" >{taskObj.description}</p>
      <div>
